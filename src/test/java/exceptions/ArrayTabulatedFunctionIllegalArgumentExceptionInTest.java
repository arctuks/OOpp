...
public class ArrayTabulatedFunctionIllegalArgumentExceptionInTest {
    ...
    void constructorOfArrayTabulatedFunction() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new ArrayTabulatedFunction(new SqrFunction(), 1, 1, 1));
    }
